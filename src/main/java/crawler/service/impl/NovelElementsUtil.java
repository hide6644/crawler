...
public class NovelElementsUtil {
     ...
     */
    static boolean existsChapterLink(final Element element) {
     ...
     */
    static boolean existsChapter(final Source html) {
     ...
     * @return 小説のタイトル
     */
    static String getTitle(final Source html) {
     ...
     * @return 小説の作者
     */
    static String getWritername(final Source html) {
     ...
     * @return 小説の解説
     */
    static String getDescription(final Source html) {
     ...
     * @return 小説の本文
     */
    static String getBody(final Source html) {
     ...
     * @return 小説の章のURL
     */
    static String getChapterUrlByNovelBody(final Element element) {
     ...
     * @return 小説の章のタイトル
     */
    static String getChapterTitle(final Source html) {
     ...
     * @return 小説の章のタイトル
     */
    static String getChapterTitleByNovelBody(final Element element, final ContensType type) {
        switch (type) {
     ...
     * @return 小説の章の本文
     */
    static String getChapterBody(final Source html) {
     ...
     */
    static String getKeyword(final Source html) {
     ...
     */
    static String getModifiedDate(final Source html) {
     ...
     */
    static boolean getFinished(final Source html) {
     ...
     * @return 小説の章の最終更新日時
     */
    static String getChapterModifiedDate(final Element element, final boolean extract) {
